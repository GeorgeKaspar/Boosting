...
from tree import ObliviousTreeBuilder, ObliviousTree, BinaryDecisionTree, TreeBuilderCART
...
class ObliviousDecisionTreeRegressor(BaseEstimator, RegressorMixin):
    def __init__(self, **kwargs):
        super(DecisionTreeRegressor, self).__init__()
        self._tree = None
